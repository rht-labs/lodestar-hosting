...
public class ExternalApiWireMock implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        stubFor(get(urlEqualTo("/api/v2/engagements/projects/cb570945-a209-40ba-9e42-63a7993baf4d")).willReturn(aResponse()
                .withHeader("Content-Type",  "application/json")
                .withBody(body)
                ));
        ...
        stubFor(get(urlEqualTo("/api/v2/engagements/projects/second")).willReturn(aResponse()
                .withHeader("Content-Type",  "application/json")
                .withBody(body)
                ));
